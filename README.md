...
|Код main|Пояснение|
|--------|--------|
|<img src="./pictures/code_main.png" width="1350">|<ol><li>В функции main программа начинает выполнение с запроса у пользователя размера массива n.</li><li>Если размер массива меньше или равен нулю, программа сообщает, что массив пуст, и завершает выполнение.</li><li>Затем выделяется динамическая память под массив arr размера n.</li><li>Пользователю предлагается ввести элементы массива.</li><li>Происходит сортировка массива с помощью функции shellSort.</li><li>Выводится отсортированный массив.</li><li>Проверяется наличие повторяющихся элементов и факт отсортированности массива, а также проводится проверка на случай, если массив состоит из одного элемента.</li><li>В зависимости от результата проверок, выводится соответствующее сообщение.</li><li> Если в массиве есть повторяющиеся элементы, программа сообщает об этом.</li><li>По окончании работы происходит освобождение выделенной памяти под массив и завершение программы.</li></ol>|
